...
import "../homeSidebarContent/sidebar_login_signup.css";

import Arrow from "../Arrow/Arrow.jsx";
import GroceryTile from "../GroceryTile/GroceryTile.jsx";
import SidebarSignup from "../homeSidebarContent/SidebarSignup.jsx";
import SidebarLogin from "../homeSidebarContent/SidebarLogin.jsx";
...
1. Fix the issue for assigning unique page title for every page.
*/
...
function Home() {
    ...
    const handleSidebarClose = (ref) => {
        ...
        setTimeout(() => { setIsLoginActive(true) }, 200) // Waits a bit to change the state, it will get changed after the sidebar is completely closed
                ...
                <header>
                    <div className="homeHeaderCont align-center">
                        ...
                        <ul className="homeNavButtons align-center">
                            ...
                            <li onClick={() => navigate("/register-restaurant")}>
                                Partner with us
                            </li>
                            ...
                            <div ref={sidebarDivRef} className="sidebarContainer">
                                ...
                                <div className="sidebarDiv">
                                    {isLoginActive
                                        ? <SidebarLogin sidebarClose={() => handleSidebarClose(sidebarDivRef)} switchToSignup={() => setIsLoginActive(false)} />
                                        : <SidebarSignup sidebarClose={() => handleSidebarClose(sidebarDivRef)} switchToLogin={() => setIsLoginActive( true)} />
                                    }
                                </div>
                            </div>
                        </ul>
